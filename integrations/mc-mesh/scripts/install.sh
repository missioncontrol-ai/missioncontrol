...
#
# Usage:
#   bash integrations/mc-mesh/scripts/install.sh
#
# What it does:
...
MC_MESH_DIR="$REPO_ROOT/integrations/mc-mesh"
...
echo "     (see integrations/mc-mesh/README.md for the schema and usage)"
echo ""
